...
En la imagen decodificada, aunque borrosa, se puede distinguir un texto que parece ser la flag del desafío. La flag es:

```
ikerlan{excuse_the_noise_jeje}
```